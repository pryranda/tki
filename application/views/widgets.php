            ...
            <div class="panel panel-default ">
                ...
                <div class="panel-body">
                    <div class="col-md-12 no-padding">
                        ...
                        <div class="progress">
                            <div data-percentage="0%" style="width: 60%;" class="progress-bar progress-bar-orange"
                                 role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="row progress-labels">
                        ...
                        <div class="progress">
                            <div data-percentage="0%" style="width: 40%;" class="progress-bar progress-bar-teal"
                                 role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="row progress-labels">
                        ...
                        <div class="progress">
                            <div data-percentage="0%" style="width: 20%;" class="progress-bar progress-bar-red"
                                 role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <ul class="todo-list">
                        <li class="todo-list-item">
                            ...
                            <div class="pull-right action-buttons"><a href="#" class="trash"><em
                ...
                <div class="panel-body">
                    <ul>
                        <li class="left clearfix"><span class="chat-img pull-left">
									<img src="<?= base_url() ?>assets/images/profile-pic-1.jpg" width="60" alt="User Avatar"
                                         class="img-circle"/>
									</span>
                            <div class="chat-body clearfix">
                                <div class="header"><strong class="primary-font">Jane Doe</strong>
                        ...
                        <li class="right clearfix"><span class="chat-img pull-right">
									<img src="<?= base_url() ?>assets/images/profile-pic-2.jpg" width="60" alt="User Avatar"
                                         class="img-circle"/>
									</span>
                            <div class="chat-body clearfix">
                                <div class="header"><strong class="pull-left primary-font">John Doe</strong>
