                    ...
                    ajax: {
                        ...
                        "dataSrc": function (json) {
                            ...
                            for (var i = 0, ien = json.data.length; i < ien; i++) {
                                ...
                                value[8] = '<a class="btn btn-default btn-circle margin center-block" href="dashboard/selesai_view/'+json.data[i]['id']+'" title="Edit" onclick=""><span class="fa fa-search"></span></a>';
